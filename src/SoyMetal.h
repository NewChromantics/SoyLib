...
public:
	...
	void			Delete();
	void			Write(const SoyPixelsImpl& Pixels,const SoyGraphics::TTextureUploadParams& Params,TContext& Context);
	void			Write(const TTexture& That,const SoyGraphics::TTextureUploadParams& Params,TContext& Context);
