...
namespace SoyMediaFormat
{
	enum Type
	{
		...
		Luma = SoyPixelsFormat::Luma,
		Yuv_8_88 = SoyPixelsFormat::Yuv_8_88,
		Yuv_8_8_8 = SoyPixelsFormat::Yuv_8_8_8,
		YYuv_8888 = SoyPixelsFormat::YYuv_8888,
		Uvy_8_88 = SoyPixelsFormat::Uvy_8_88,
