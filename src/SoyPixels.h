...
public:
	...
	void			SplitPlanes(size_t PixelDataSize,ArrayBridge<std::tuple<size_t,size_t,SoyPixelsMeta>>&& PlaneOffsetSizeAndMetas) const;	//	get all the plane split info, asserts if data doesn't align
